...
const navigation: NavItem[] = [
  ...
  { name: 'Saved Ads', href: '/dashboard/favorites', icon: HeartIcon },
...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-48 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:top-0 top-[110px] ${
          sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        <div className="flex flex-col h-full">
          {/* Home Button (hidden on mobile - logo is in fixed header) */}
