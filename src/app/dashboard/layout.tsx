...
const SavedSearchIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const navigation: NavItem[] = [
  ...
  { name: 'My Store', href: '/dashboard/store', icon: StoreIcon },
  { name: 'Analytics', href: '/dashboard/analytics', icon: BarChartIcon },
  { name: 'Saved Searches', href: '/dashboard/saved-searches', icon: SavedSearchIcon },
  { name: 'Verification', href: '/dashboard/verification', icon: VerificationIcon },
