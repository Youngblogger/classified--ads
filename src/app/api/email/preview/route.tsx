...
const templates: Record<string, (props?: Record<string, string>) => React.ReactElement> = {
  ...
  AdBoosted: (props) => <AdBoosted adTitle="iPhone 14 Pro Max 256GB" adSlug="iphone-14-pro-max" plan="Gold - 7 Days" amount="3,500" walletBalance="12,000" expiryDate="June 18, 2026" transactionId="TXN-123456789" {...props} />,
  ...
  PaymentReceipt: (props) => <PaymentReceipt receiptNumber="RCP-20260611-001" paymentMethod="Paystack - Card" date="June 11, 2026" amount="3,500" total="3,500" walletBalance="12,000" {...props} />,
  WalletFunded: (props) => <WalletFunded amount="50,000" method="Paystack - Transfer" balance="62,000" transactionId="TXN-123456789" date="June 11, 2026" {...props} />,
  WithdrawalSuccessful: (props) => <WithdrawalSuccessful amount="20,000" bankName="GTBank" accountNumber="0123456789" accountName="John Doe" balance="42,000" reference="WDR-123456" estimatedArrival="June 14, 2026" {...props} />,
