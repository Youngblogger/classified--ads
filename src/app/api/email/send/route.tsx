...
const templateMap: Record<string, (props: Record<string, unknown>) => React.ReactElement> = {
  ...
  AdExpired: (props) => <AdExpired adTitle="iPhone 14 Pro Max 256GB" adSlug="iphone-14-pro-max" repostLink="https://example.com/repost" {...(props as Record<string, string>)} />,
   AdBoosted: (props) => <AdBoosted adTitle="iPhone 14 Pro Max 256GB" adSlug="iphone-14-pro-max" plan="Gold - 7 Days" amount="3,500" walletBalance="12,000" expiryDate="June 28, 2026" transactionId="WLB20260621ABCDEFGHIJ" {...(props as Record<string, string>)} />,
  BoostExpiring: (props) => <BoostExpiring adTitle="iPhone 14 Pro Max 256GB" adSlug="iphone-14-pro-max" daysLeft={1} renewLink="https://example.com/renew" {...(props as Record<string, string>)} />,
   PaymentReceipt: (props) => <PaymentReceipt receiptNumber="ILR-20260621-A9KX4P00" paymentMethod="Paystack - Card" date="June 21, 2026" amount="3,500" total="3,500" walletBalance="12,000" {...(props as Record<string, string>)} />,
   WalletFunded: (props) => <WalletFunded amount="50,000" method="Paystack - Transfer" balance="62,000" transactionId="ILT-20260621-A9KX4P00" date="June 21, 2026" {...(props as Record<string, string>)} />,
   WithdrawalSuccessful: (props) => <WithdrawalSuccessful amount="20,000" bankName="GTBank" accountNumber="0123456789" accountName="John Doe" balance="42,000" reference="ILB-20260621-A9KX4P00" estimatedArrival="June 24, 2026" {...(props as Record<string, string>)} />,
