...
const REPORT_REASONS: ReportReason[] = [
  { value: 'spam', label: 'Spam / Scam', icon: <Ban className="w-5 h-5" /> },
  { value: 'misleading', label: 'Misleading Information', icon: <AlertTriangle className="w-5 h-5" /> },
  { value: 'wrong_category', label: 'Wrong Category', icon: <FolderOpen className="w-5 h-5" /> },
  { value: 'duplicate', label: 'Duplicate Ad', icon: <Copy className="w-5 h-5" /> },
  { value: 'prohibited', label: 'Prohibited Item', icon: <Prohibited className="w-5 h-5" /> },
  { value: 'offensive', label: 'Offensive Content', icon: <MessageSquare className="w-5 h-5" /> },
      ...
      <div className="bg-white rounded-t-3xl sm:rounded-xl w-full sm:max-w-md max-h-[85vh] sm:max-h-[85vh] flex flex-col shadow-2xl pb-safe">
        ...
        <div className="px-4 sm:px-5 py-3 overflow-y-auto flex-1">
          ...
          <div className="mt-5">
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent resize-none placeholder:text-gray-400"
            />
          </div>
        </div>
        ...
        <div className="px-5 py-4 border-t border-gray-200 flex gap-3 flex-shrink-0 bg-white">
          ...
          <button
            ...
            className={`
              flex-1 px-5 py-3 rounded-xl font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-2
