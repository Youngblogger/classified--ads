...
export default function LoginModal() {
          ...
          setError(
            <span>
              ...
              <a 
                ...
                className="text-[#4B5320] font-semibold hover:underline"
              >
                Verify now
              </a>
            </span>
  ...
  return (
    <div className={isLoginModalOpen ? '' : 'hidden'}>
      ...
      >
        <div 
          className="bg-white rounded-3xl shadow-2xl max-w-md w-full animate-scale-in overflow-hidden"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header with gradient */}
          <div className="bg-gradient-to-r from-[#4B5320] to-[#3d4220] p-6 text-white">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold">Welcome Back!</h2>
                <p className="text-green-100 text-sm mt-1">Sign in to continue to iList</p>
              </div>
            ...
            <div className="flex gap-2 p-1 bg-gray-100 rounded-xl mb-6">
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-all ${
                  loginMethod === 'email' 
                    ? 'bg-white text-[#4B5320] shadow-sm font-semibold' 
              ...
              <form onSubmit={handleEmailLogin} className="space-y-5">
                ...
                <div className="flex justify-between items-center">
                  <label className="flex items-center gap-2">
                    <input type="checkbox" className="w-4 h-4 text-[#4B5320] rounded border-gray-300 focus:ring-[#4B5320]" />
                    <span className="text-sm text-gray-600">Remember me</span>
                  </label>
                  <Link href="/forgot-password" className="text-sm text-[#4B5320] hover:text-[#3d4220] font-medium">
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled={otpSent}
                      className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4B5320]/20 focus:border-[#4B5320] transition-all disabled:bg-gray-100"
                    />
                  </div>
                </div>
                ...
                {!otpSent ? (
                  ...
                  <>
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-3 text-center">Enter 4-digit code</label>
                      <div className="flex justify-center gap-3">
                        {otp.map((digit, index) => (
                          <input
                            ...
                            disabled={isSubmitting}
                            className="w-14 h-14 text-center text-xl font-bold rounded-xl border-2 focus:border-[#4B5320] focus:ring-2 focus:ring-[#4B5320]/20 outline-none bg-gray-50 transition-all"
                          />
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="text-center">
                      {countdown > 0 ? (
                        ...
                        <button
                          ...
                          className="text-[#4B5320] hover:text-[#3d4220] text-sm font-medium"
                        >
                          Resend OTP Code
                        </button>
                      )}
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50"
                  >
