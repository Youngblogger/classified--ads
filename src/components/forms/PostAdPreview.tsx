...
function getConditionBadge(condition: string): { label: string; className: string } {
  ...
  if (c === 'new' || c === 'brand_new') return { label: 'New', className: 'bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-400' };
  if (c === 'like_new' || c === 'like new') return { label: 'Like New', className: 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' };
  if (c === 'good') return { label: 'Used', className: 'bg-amber-50 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400' };
  if (c === 'fair') return { label: 'Refurbished', className: 'bg-yellow-50 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' };
  return { label: c, className: 'bg-gray-50 text-gray-600 dark:bg-gray-800 dark:text-gray-400' };
}
  ...
  return (
    <div className="space-y-0">
      ...
      <div className="relative -mx-4 sm:-mx-6 lg:-mx-8 mb-6">
        <div
          className="relative aspect-[4/3] sm:aspect-[21/9] bg-gray-100 dark:bg-gray-800 overflow-hidden"
        ...
        >
          ...
          <div className="absolute top-3 right-3 flex gap-2">
            <button
              ...
              className="w-9 h-9 rounded-full bg-white/90 dark:bg-gray-800/90 flex items-center justify-center hover:bg-white dark:hover:bg-gray-800 transition-all shadow-sm backdrop-blur-sm"
            >
              <Heart className={`w-4 h-4 ${isFavorited ? 'fill-red-500 text-red-500' : 'text-gray-600 dark:text-gray-300'}`} />
            </button>
            <button className="w-9 h-9 rounded-full bg-white/90 dark:bg-gray-800/90 flex items-center justify-center hover:bg-white dark:hover:bg-gray-800 transition-all shadow-sm backdrop-blur-sm">
      ...
      <div className="max-w-4xl mx-auto px-0 sm:px-2 space-y-6 pb-32 sm:pb-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2 mt-2">
                ...
                {categoryBreadcrumb && (
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400">
                    {categoryBreadcrumb}
                  </span>
                )}
              </div>
          ...
          <div className="flex items-baseline gap-3">
            ...
            {negotiable && (
              <span className="text-xs font-semibold bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-2 py-0.5 rounded-full border border-green-200 dark:border-green-700">
                Negotiable
              </span>
            )}
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-3 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2 text-gray-400 dark:text-gray-500 text-xs font-medium mb-1">
            ...
            <div className="px-4 py-3">
              ...
              {descOverflow && (
                <button
                  ...
                  className="mt-2 text-sm font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 flex items-center gap-1"
                >
                  {showAllDesc ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm">
          <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
            <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100">Seller Information</h3>
          </div>
          <div className="p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="ml-auto">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 rounded-full text-xs font-semibold">
            ...
            <div className="space-y-2">
              {phone && (
                <a
                  href={`tel:${phone}`}
                  className="flex items-center gap-3 w-full px-4 py-2.5 bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-300 rounded-xl hover:bg-primary-100 dark:hover:bg-primary-900/40 transition-colors font-semibold text-sm"
                >
              ...
              {whatsapp && (
                <a
                  ...
                  className="flex items-center gap-3 w-full px-4 py-2.5 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 rounded-xl hover:bg-green-100 dark:hover:bg-green-900/40 transition-colors font-semibold text-sm"
                >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm">
          <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
            <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100">Safety Tips</h3>
          </div>
          <div className="p-4 space-y-3">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{tip.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4 sm:hidden z-40 shadow-2xl">
        <div className="flex items-center justify-between mb-3">
          <div>
            <span className="text-lg font-black text-gray-900 dark:text-gray-100">
              ₦{price ? Number(price).toLocaleString() : '0'}
            </span>
            {negotiable && <span className="text-xs text-green-600 dark:text-green-400 ml-2 font-semibold">Negotiable</span>}
          </div>
          <button
            onClick={onBack}
      ...
      <div className="hidden sm:flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700 mt-6">
        <button
          onClick={onBack}
          className="px-5 py-2.5 border-2 border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-400 rounded-xl text-sm font-semibold hover:border-primary-300 dark:hover:border-primary-600 hover:text-primary-600 dark:hover:text-primary-400 transition-all flex items-center gap-2"
        >
