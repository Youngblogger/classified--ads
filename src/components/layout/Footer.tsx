...
export default function Footer() {
  ...
  const socialLinks = [
    { 
      label: 'Facebook', 
      href: 'https://facebook.com/ilist', 
      icon: Facebook 
    },
    { 
      label: 'Instagram', 
      href: 'https://instagram.com/ilist', 
      icon: Instagram 
    },
    { 
      label: 'Twitter (X)', 
      href: 'https://twitter.com/ilist', 
      icon: Twitter 
    },
  ];
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="container-app py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <Link 
              href="/post-ad"
              className="btn bg-white text-primary-600 hover:bg-gray-100 px-8 py-3 text-base font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2"
            >
              Post Your Ad
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all"
                  />
                </div>
                <button
                  type="submit"
                  disabled={isSubscribing}
                  className="btn bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isSubscribing ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  href="#"
                  className="flex items-center gap-3 px-4 py-2.5 bg-black/30 hover:bg-black/40 border border-white/10 rounded-xl transition-all duration-200"
                >
              ...
              <div className="flex flex-wrap gap-2">
                {popularSearches.map((search, index) => (
                  <Link
                    ...
                    className="px-3 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full text-sm text-gray-400 hover:text-white transition-all duration-200"
                  >
                    {search}
                  </Link>
                ))}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="text-lg font-display font-bold">iList</span>
              </Link>
