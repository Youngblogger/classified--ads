...
class Ad extends Model
{
    protected $fillable = [
        ...
        'edited_by_admin', 'is_seeded', 'quality_score', 'is_flagged', 'quality_flags', 'last_quality_check', 'idempotency_key',
    ];
    ...
    {
        return $query->with(['images', 'category', 'location', 'user', 'activeBoost.plan'])
            ->active()
