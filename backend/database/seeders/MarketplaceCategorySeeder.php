        ...
        return [
            ...
            [
                ...
                'subcategories' => [
                    ...
                    ['name' => 'Kids Bags', 'slug' => 'kids-bags', 'icon' => 'ShoppingBag', 'is_active' => true],
            ...
            [
                ...
                'subcategories' => [
                    ...
                    ['name' => 'Bags', 'slug' => 'bags', 'icon' => 'ShoppingBag', 'is_active' => true],
            ...
            [
                ...
                'sort_order' => 6,
                'subcategories' => [
                    ['name' => 'Skincare', 'slug' => 'skincare', 'icon' => 'Sparkles', 'is_active' => true],
                    ['name' => 'Face Care', 'slug' => 'face-care', 'icon' => 'Sun', 'is_active' => true],
                    ['name' => 'Body Care', 'slug' => 'body-care', 'icon' => 'Droplets', 'is_active' => true],
                    ['name' => 'Makeup', 'slug' => 'makeup', 'icon' => 'Gem', 'is_active' => true],
                    ...
                    ['name' => 'Fragrances', 'slug' => 'fragrances', 'icon' => 'Sparkles', 'is_active' => true],
                    ['name' => 'Oral Care', 'slug' => 'oral-care', 'icon' => 'Shield', 'is_active' => true],
                    ['name' => 'Personal Care', 'slug' => 'personal-care', 'icon' => 'Heart', 'is_active' => true],
                    ['name' => 'Beauty Tools', 'slug' => 'beauty-tools', 'icon' => 'Wrench', 'is_active' => true],
                    ['name' => 'Salon Equipment', 'slug' => 'salon-equipment', 'icon' => 'Wrench', 'is_active' => true],
                    ['name' => 'Spa Equipment', 'slug' => 'spa-equipment', 'icon' => 'Droplets', 'is_active' => true],
                    ['name' => 'Vitamins', 'slug' => 'vitamins', 'icon' => 'Sparkles', 'is_active' => true],
                    ['name' => 'Supplements', 'slug' => 'supplements', 'icon' => 'Sparkles', 'is_active' => true],
                    ...
                    ['name' => 'Grooming Tools', 'slug' => 'grooming-tools', 'icon' => 'Wrench', 'is_active' => true],
                    ['name' => 'Medical Beauty Devices', 'slug' => 'medical-beauty-devices', 'icon' => 'Shield', 'is_active' => true],
                    ['name' => 'Organic Beauty', 'slug' => 'organic-beauty', 'icon' => 'Sun', 'is_active' => true],
            ...
            [
                ...
                'subcategories' => [
                    ...
                    ['name' => 'Cats', 'slug' => 'cats', 'icon' => 'Cat', 'is_active' => true],
                    ['name' => 'Kittens', 'slug' => 'kittens', 'icon' => 'Cat', 'is_active' => true],
                    ['name' => 'Birds', 'slug' => 'birds', 'icon' => 'Bird', 'is_active' => true],
                    ['name' => 'Fish', 'slug' => 'fish', 'icon' => 'Fish', 'is_active' => true],
                    ['name' => 'Rabbits', 'slug' => 'rabbits', 'icon' => 'Rabbit', 'is_active' => true],
                    ['name' => 'Livestock Pets', 'slug' => 'livestock', 'icon' => 'Dog', 'is_active' => true],
                    ['name' => 'Pet Food', 'slug' => 'pet-food', 'icon' => 'ShoppingBag', 'is_active' => true],
                    ['name' => 'Pet Accessories', 'slug' => 'pet-accessories', 'icon' => 'ShoppingBag', 'is_active' => true],
                    ['name' => 'Pet Healthcare', 'slug' => 'pet-healthcare', 'icon' => 'Heart', 'is_active' => true],
                    ['name' => 'Aquariums', 'slug' => 'aquariums', 'icon' => 'Fish', 'is_active' => true],
                    ['name' => 'Pet Toys', 'slug' => 'pet-toys', 'icon' => 'ToyBrick', 'is_active' => true],
                    ['name' => 'Pet Grooming', 'slug' => 'pet-grooming', 'icon' => 'Wrench', 'is_active' => true],
                    ['name' => 'Pet Services', 'slug' => 'pet-services', 'icon' => 'Dog', 'is_active' => true],
                    ['name' => 'Pet Housing', 'slug' => 'pet-housing', 'icon' => 'Home', 'is_active' => true],
                    ['name' => 'Reptiles', 'slug' => 'reptiles', 'icon' => 'Turtle', 'is_active' => true],
                    ['name' => 'Exotic Pets', 'slug' => 'exotic-pets', 'icon' => 'PawPrint', 'is_active' => true],
                    ['name' => 'Pet Training', 'slug' => 'pet-training', 'icon' => 'Book', 'is_active' => true],
            ...
            [
                ...
                'subcategories' => [
                    ...
                    ['name' => 'Camping Gear', 'slug' => 'camping-gear', 'icon' => 'Tent', 'is_active' => true],
                    ['name' => 'Hiking Equipment', 'slug' => 'hiking-equipment', 'icon' => 'Footprints', 'is_active' => true],
                    ...
                    ['name' => 'Swimming Equipment', 'slug' => 'swimming-equipment', 'icon' => 'Droplets', 'is_active' => true],
                    ['name' => 'Boxing Equipment', 'slug' => 'boxing-equipment', 'icon' => 'Dumbbell', 'is_active' => true],
                    ['name' => 'Indoor Games', 'slug' => 'indoor-games', 'icon' => 'Gamepad', 'is_active' => true],
                    ...
                    ['name' => 'Fishing Equipment', 'slug' => 'fishing-equipment', 'icon' => 'Fish', 'is_active' => true],
                    ['name' => 'Running Equipment', 'slug' => 'running-equipment', 'icon' => 'Footprints', 'is_active' => true],
                    ['name' => 'Outdoor Cooking', 'slug' => 'outdoor-cooking', 'icon' => 'Coffee', 'is_active' => true],
                    ['name' => 'Travel Accessories', 'slug' => 'travel-accessories', 'icon' => 'ShoppingBag', 'is_active' => true],
                ],
            ],
        ];
    }
